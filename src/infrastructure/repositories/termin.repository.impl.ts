...
import type { TerminSubmission, CreateTerminRequest, CreateTerminResponse, ReviewTerminRequest, ApproveTerminRequest } from '../../domain/entities/termin-submission.entity';
